...
class Forgetting(EarlyTrain):
    ...
    def after_epoch(self):
        ...
        self.score_tracker[self.current_epoch]=self.forgetting_events
    ...
    def before_run(self):
        ...
        self.score_tracker= torch.zeros((self.epochs, self.n_train)).to(self.args.device)
    ...
    def select(self, **kwargs):
        ...
        return {"indices": top_examples, "scores": self.forgetting_events, "score_tracker": self.score_tracker.cpu().numpy()}
