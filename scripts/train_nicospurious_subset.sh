...
CUDA_VISIBLE_DEVICES=0 python -u train.py --fraction $1 --dataset Nico_95_spurious --data_path ~/datasets --num_exp 1 --workers 10 --optimizer SGD -se 10 --selection $2 --model ResNet18 --lr 0.001 -sp $3 --batch 128 --balance False --pretrain True --linear_probe False --subset_path $4 --score_path $5 --level $6 --policy $7 --score_pretrain False
