...
CUDA_VISIBLE_DEVICES=0 python -u train_backup.py --fraction $1 --dataset CelebAhair --data_path /n/fs/dk-diffusion/repos/DomainBiasMitigation/data/celeba_outer/celeba_halfmaleblond --workers 10 --optimizer SGD --selection $2 --model ResNet50 --lr 0.001 -sp $3 --balance False --pretrain True --linear_probe False --score_path $4 --policy $5 --score_pretrain True -wd $6 --class_balance True --class_equal $7 --scheduler None --epochs $8 #--features $9 #--num_exp $10 
