...
for method in methods:
    for fraction in fractions:
        ...
        for policy in policies:
            ...
            score_path= f'./all_results_SGD/cmnist_pretrained/Cmnist_ResNet18_{method}_exp0_0.1_unknown.ckpt'
            os.system(f"bash run_cmnist_train.sh {fraction} {method} {sp} {score_path} {policy} {wd} {class_equal} {train_epochs}")
