...
# coreset_methods= ['Moderate2', 'SelfSup']
...
#     for k in range(4):
#         # os.system("cd ..")
#         # os.system(f"CUDA_VISIBLE_DEVICES=0 python -u /n/fs/dk-diffusion/repos/DeepCore/main.py --fraction 0.1 --dataset waterbirds --data_path /n/fs/visualai-scr/Data/waterbird/waterbird_complete95_forest2water2 --num_exp 1 --workers 10 -se {se} --selection {coreset_methods[j]} -sp /n/fs/dk-diffusion/repos/DeepCore/all_results_SGD/waterbirds_pretrained_feature_extractors --batch 128 --balance False --pretrain True --linear_probe False --uncertainty Entropy --precalcfeatures_path {feature_paths[k]} --model {models[k]}")
#         # os.system(f"CUDA_VISIBLE_DEVICES=0 python -u /n/fs/dk-diffusion/repos/DeepCore/main.py --fraction 0.1 --dataset Metashift --data_path /n/fs/visualai-scr/Data/ --num_exp 1 --workers 10 -se {se} --selection {coreset_methods[j]} -sp /n/fs/dk-diffusion/repos/DeepCore/all_results_SGD/metashift_pretrained_feature_extractors --batch 128 --balance False --pretrain True --linear_probe False --uncertainty Entropy --precalcfeatures_path {feature_paths[k]} --model {models[k]}")
#         os.system(f"CUDA_VISIBLE_DEVICES=0 python -u /n/fs/dk-diffusion/repos/DeepCore/main.py --fraction 0.1 --dataset Nico_95_spurious --data_path ~/datasets --num_exp 1 --workers 10 -se {se} --selection {coreset_methods[j]} -sp /n/fs/dk-diffusion/repos/DeepCore/all_results_SGD/metashift_pretrained_feature_extractors --batch 128 --balance False --pretrain True --linear_probe False --uncertainty Entropy --precalcfeatures_path {feature_paths[k]} --model {models[k]}")
#         time.sleep(1)