...
methods= ['EL2N', 'SelfSup']#, 'unsupHerding', 'supProto', 'supHerding']
# methods= ['supHerding']
...
policies= ['difficult', 'easy']#, 'difficult-groupbal', 'easy-groupbal', 'groupbal-hard_majority', 'groupbal-easy_majority']
# policies= ['random']
...
for method in methods:
    for fraction in fractions:
        ...
        for policy in policies:
            ...
            os.system(f"sbatch run_cxr8_train.sh {fraction} {method} {sp} {score_path} {policy} {wd} {class_equal} {train_epochs}")
