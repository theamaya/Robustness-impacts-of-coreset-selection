...
def get_subset(subset_path=None, score_path=None, selection=None, fraction=None, policy=None, class_balance= False, class_equal= False, class_labels= None, context_labels=None):
...
def main():
    ...
    for exp in range(start_exp, args.num_exp):
        ...
        project="Bias_in_selection-training-baselines(imagenet)",
        # track hyperparameters and run metadata
        config= vars(args),
        name= checkpoint_name)

        ###########
        subset = get_subset(args.subset_path, args.score_path, args.selection, args.fraction, args.policy, args.class_balance, args.class_equal, class_labels, context_labels)
        ###########
        ...
        #         print("| Training on model %s" % model)
            ...
            args.test_interval= int(args.epochs/50)
